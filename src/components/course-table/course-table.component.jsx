            ...
            <Tbody>
                {Object.entries(getCourseData).map(course => {
                    return <Tr key={course[0]}>
                        <Td textAlign={"center"}>{course[1]["state"]}</Td>
                        <Td textAlign={"center"}>{course[1]["transfer_school"]}</Td>
                        <Td textAlign={"center"}>{course[1]["transfer_class"]}</Td>
                    </Tr>
                })}
            </Tbody>
        </Table>
